...
{{-- home.order_confirm --}}
      {!! Form::open(['route' => 'home.order_confirm', 'method' => 'POST', 'name' => 'order_confirm', 'onsubmit' => 'return MakeFormValid()']) !!}
        ...
        <div class="table-responsive confirm_order">
          <table class="table" id="orders">
            ...
            <tr>
              ...
              <td style="text-align:right">&pound;{{$order->item_price}}</td>
              <td>{{$order->item_qty}}</td>
              <td style="text-align:right">&pound;{{number_format($order->item_qty*$order->item_price, 2)}}</td>
            </tr>
            <input value="{{$order->item_id}}" type="hidden" name="itemId[]">
            <input value="{{$order->item_name}}" type="hidden" name="itemName[]">
            <input value="{{$order->item_price}}" type="hidden" name="itemPrice[]">
            <input value="{{$order->item_qty}}" type="hidden" name="itemQty[]">
            <input value="{{number_format($order->item_qty*$order->item_price, 2)}}" type="hidden" name="Price[]">
            <?php
            ...
            <tr>
              ...
              <th colspan="2" style="text-align:right">&pound;{{number_format($total_price, 2)}}</th>
            </tr>
            <input value="{{number_format($total_price, 2)}}" type="hidden" name="total_price">
          </table>
        </div>
