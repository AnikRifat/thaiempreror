                ...
                <article class="article">
                    <div class="article-title">
                        <ul class="blog-detail list-unstyled list-inline">
                            <li><i class="fa fa-calendar mx-2"></i>{{ $date }}</li>
                ...
                <div class="widget widget-latest-post">
                    ...
                    <div class="widget-body">
                        ...
                        <article class="article">
                            ...
                            @foreach ($leatestBlog as $item)

                            <div class="latest-post-aside media">

                                <div class="lpa-right">
                                    <a href="#">
                                        <img src="/images/home/{{ $item->image}}" alt="">
                                    </a>
                                </div>
                                <div class="lpa-left media-body">
                                    <div class="lpa-title">
                                        <h5><a href="{{ route('blog.details',$item->id) }}">{{ $item->title }}</a>
                                        </h5>
                                    </div>
                                </div>
                            </div>
