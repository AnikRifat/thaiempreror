...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                {!! Form::model($ticket, ['route' => ['admin.update.container.ticket', $ticket->id], 'method' => 'PUT', 'id' => 'RegisterValidation']) !!}
                ...
                <div class="card-content">
                    ...
                    <div class="ticket-buttons pull-right">
                        ...
                        <a href="/admin/work_order_details/{{$worder->id}}" class="btn btn-warning">Cancel</a>
