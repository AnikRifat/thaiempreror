        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    {!! Form::model($container, ['route' =>['admin.update.container', $container->id], 'method' => 'PUT', 'id' => 'RegisterValidation']) !!}
                    <div class="col-md-12">
...
{{ Form::text('adtl_bol_3', $container->add_bol3, ['class' => 'form-control border-input']) }}
                    ...
                    <a href="/admin/add_container_ticket/{{$container->id}}" class="btn btn-info btn-fill pull-right">Add Ticket</a>
                    <a href="/admin/work_order_details/{{$worder->id}}" class="btn btn-default btn-fill pull-right">Back to work order</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
