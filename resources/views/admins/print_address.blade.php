...
<div id="table" name="table" style="margin:10px auto; width:8.2in; background:#fff;border:none!important">
			<?php $r = 1; $pb = 1; $pc = 1; ?>
			@foreach($users as $user)
			@if($user->property_no != "")
			<div style="width:33%; display:table; float:left;">
				<table class="table table-bordered" style="width:90%; font-size:19px; text-align:left!important;margin-left:15px!important;margin-bottom:15px;margin-top:10px;">
					<tr>
            ...
            <?php
		        if($r != 0 && $r % 3 == 0){
		        	echo '<div style="width:100%;clear:both;padding:0;margin:0;"></div>';
		        } 
		        if($pb != 0 && $pb % 15 == 0){
		        	echo '<div style="clear:both;width:100%; border-bottom:1px solid #eee;font-weight:700;text-align:right"> Page: '.$pc.'</div>';
