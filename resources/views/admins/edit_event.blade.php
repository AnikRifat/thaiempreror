    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-content">
                ...
                {!! Form::model($event, ['route' => ['admin.update.event', $event->id], 'method' => 'PUT', 'id' =>
                ...
                <div class="row">
                    <div class=" col-md-12">
                        ...
                        <div class="">
                            ...
                            {{ Form::file('image', ['class' => 'dropify','data-default-file'=>'/images/home/'. $event->image ,
                            'style' => 'border-bottom:1px solid #ccc; padding:10px 5px;']) }}
                        </div>
                        <div class="form-group">
                            <label> <input type="radio" class="" name="status" value="1" {{$event->status == 1?
                                'checked':''}}> Active &nbsp;</label>
                            <label> <input type="radio" class="" name="status" value="0" {{$event->status == 0?
