@extends('user')
@section('title', 'Finished Work Order')
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Showing Finished Work Orders</h4>
                <div class="toolbar">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="/work_order_details/{{ $workorder->id }}" class="btn btn-simple btn-warning btn-icon" title="Edit the record"><i class="material-icons">mode_edit</i></a>
                                </td>
                            </tr>
