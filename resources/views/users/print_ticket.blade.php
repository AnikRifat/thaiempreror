...
<div class="col-md-6 col-md-offset-3">
	...
	<h5>
		<p style="padding-left: 40px;padding-right: 40px;">Please go back to container section of this Bill of Lading and try adding a new ticket only then you will be able to print ticket.</p>
		<a href="#" onclick="window.close()">Back to the work order</a>
