...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                {{ Form::open(['route' => 'add.address', 'method' => 'POST', 'id' => 'RegisterValidation']) }}
                    <div class="card-header card-header-icon" data-background-color="rose">
                        <i class="material-icons">add</i>
                    </div>
                    <div class="card-content">
                        <h4 class="card-title">Add Pickup & Delivery Address</h4>
                        ...
                        <div class="form-footer text-right">
                            <button type="submit" class="btn btn-rose btn-fill">Add Address</button>
                        </div>
                    </div>
                {{ Form::close() }}
            </div>
