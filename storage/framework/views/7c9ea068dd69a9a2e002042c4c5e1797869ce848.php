                ...
                <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($r); ?></td>
                                <td><img src="/images/home/<?php echo e($blog->image); ?>" alt="" style="max-width:100px"></td>
                                <td><?php echo e($blog->title); ?></td>
                                <td><?php echo e($blog->sub_title); ?></td>
                                ...
                                <td class="text-right">
                                    <a href="/admin/edit_blog/<?php echo e($blog->id); ?>" class="btn btn-simple btn-warning btn-icon" title="Edit Blog"><i class="material-icons">edit</i></a>

    <?php if(Auth::guard('admin')->user()->user_role == 'SUPER-ADMIN'): ?>

    <a href="#" class="btn btn-simple btn-danger btn-icon" title="Delete this blog!" onclick="document.getElementById('target<?php echo e($r); ?>').style.display = 'block';"><i class="material-icons">delete</i></a>

    <?php echo e(Form::open(['route' => ['admin.blog.delete', $blog->id], 'method' => 'DELETE'])); ?>
