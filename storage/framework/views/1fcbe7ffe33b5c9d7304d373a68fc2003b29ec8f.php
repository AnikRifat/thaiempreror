            ...
            <li><a name="<?php echo e('cat'.$cat->id); ?>" onclick="showCat(this)"><?php echo e($cat->cat_name); ?></a>
              ...
              <ul style="display:none" class="subCat sub-cats">
                ...
                <li><a onClick="showSubCat(this);"
                    name="<?php echo e($cat->id.'subcat'.$subcat->id); ?>"><?php echo e($subcat->sub_cat_name); ?></a></li>
      ...
      <div class="col-md-7">
        ...
        <div class="gallery-items">
          ...
          <div class="ItemCat" id="<?php echo e('cat'.$cat->id); ?>">
            ...
            <div class="ItemSubCat" id="<?php echo e($cat->id.'subcat'.$subcat->id); ?>">
              <!--sub-cat-block-->
      ...
      <div class="col-xs-12 col-sm-6">
        <div class="booking-back">
          <div class="booking-form">
            ...
            <?php echo Form::open(['route' => 'reservation.store', 'method' => 'POST', 'files' => true, 'name' =>
...
<div class="book-now-wrapper">
  ...
  <div class="book-now ">
    <div class="book-form">
      ...
      <?php echo Form::open(['route' => 'reservation.store', 'method' => 'POST', 'files' => true, 'name' => 'sidebarForm', 'id'
      => 'sidebar_form']); ?>
