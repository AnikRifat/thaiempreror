<body data-spy="scroll" onload="initialize()" data-target="#navbar">
  ...
  <div class="allAlerts" id="allAlerts" onclick="this.style.display='none';"  style="display:none">
    <div id="sub_alert" style="position: fixed; right: 5%; margin: 0px auto; z-index: 99999; top: 40%; border: 2px solid #f00; max-width: 400px; text-align: center; left: 5%; padding: 10px; background: #fff;color:#f00"></div>
  </div>
          ...
          <div>
            <div class="col-xs-12 hidden-xs col-sm-12 col-md-offset-4">
              ...
              <ul class="fa-ul list-inline top-info level-one">
                        <li><a target="_blank" href="https://www.facebook.com/Thai-Emperor-Restaurant-Takeaway-112619794007991/"><img src="/images/home/facebook.png" alt="Facebook" width="32"></a></li>
                        <li><a target="_blank" href="https://www.tripadvisor.co.uk/Restaurant_Review-g1962041-d23161948-Reviews-Thai_Emperor-Swanley_Sevenoaks_District_Kent_England.html"><img src="/images/home/tripadd.png" alt="Trip Advisor" width="32"></a></li>

                        <li>Call Us Today:  <a class="tel-no"><i class="fa fa-phone"></i> +44 7375 1000 96</li>
                        <li><i class="fa fa-envelope"></i><a class="tel-no" href="mailto:thai_emperor@hotmail.com"> thai_emperor@hotmail.com</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <header class="header-wrapper manu-fixed">
                    <div class="container">
                      <div class="col-xs-3 col-md-2">
                        <div class="logo">
                          <a title="<?php echo e(config('app.name')); ?>" href="#">
              ...
              <div class="navbar navbar-default mainnav">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                  ...
                  <ul class="nav navbar-nav navbar-right hidden-sm  hidden-xs">
                    ...
                    <li><a class="page-scroll" href="https://www.thaiemperor.uk/order.aspx" target="_blank">Online Order</a></li>
