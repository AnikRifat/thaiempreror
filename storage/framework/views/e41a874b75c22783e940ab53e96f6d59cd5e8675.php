        ...
        <div class="card">
            ...
            <div class="card-header card-header-icon" data-background-color="purple">
                ...
                <div class="card-content">
                    ...
                    <?php echo Form::open(['route' => 'admin.create.event', 'method' => 'POST', 'id' => 'RegisterValidation', 'files' => true]); ?>
                    ...
                    <div class="row">
                        <div class=" col-md-12">
                            ...
                            <div class="">
                                ...
                                <?php echo e(Form::file('image', ['class' => '', 'style' => 'border-bottom:1px solid #ccc; padding:10px 5px;width:100%'])); ?>
