    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <?php echo Form::open(['route' => 'admin.create.event', 'method' => 'POST', 'id' => 'RegisterValidation',
                'files' => true]); ?>
                ...
                <div class="row">
                    <div class=" col-md-12">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <?php echo e(Form::text('footer_text', null, ['class' => 'form-control border-input'])); ?>

                        </div><br>
                        <div class="">
                            <?php echo e(Form::label('image', 'Upload Image (Image Dimension: 570x298)', ['class' => ''])); ?>

                            <?php echo e(Form::file('image', ['class' => 'dropify','data-max-file-size'=>'3M','data-width'=>'400', 'style' => 'border-bottom:1px solid #ccc; padding:10px 5px'])); ?>
