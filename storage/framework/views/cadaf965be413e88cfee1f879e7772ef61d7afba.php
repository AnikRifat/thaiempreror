...
<style type="text/css">
  .tp-top-text{font-size: 38px!important;}
</style>
...
<div class="slider-one">
    <div class="tp-banner-container">
      <div class="tp-banner" >
        <ul>
          <!-- SLIDE  1-->
          <li data-transition="slotfade-horizontal" data-slotamount="1" data-masterspeed="500" data-title="Tandoori Chicken">
            <!-- MAIN IMAGE -->
            <img src="/images/home/slider3.jpg"  alt="slidebg1" data-lazyload="/images/home/slider3.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYER NR. 2 -->
            <div class="tp-caption tp-resizeme sft" data-x="220" data-y="50" data-speed="1000" data-start="2400" data-endspeed="300" data-captionhidden="off" style="z-index: 7; max-width: auto; max-height: auto; font-family : 'Playball', sans-serif;color: #fff;font-size:91px; line-height:50px; text-align:center">
              <span class="slider-text-1" style="font-size: 33px;font-family: 'Merriweather', sans-serif;">We take our</span><br>
                  Responsibilities<br>
                  <span class="slider-text-2" style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;  font-family: 'Roboto', sans-serif;text-transform: uppercase; font-size: 18px;letter-spacing: 4px; color: #fff;text-shadow:5px 5px 5px #000">your satisfaction is our main priority<br>
                  <a target="_blank" href='https://www.thaiemperor.uk/order.aspx'  class="slider-text-3 tr-slider-btn" style="z-index: 12; max-width: auto; max-height: auto; white-space: nowrap;font-size:22px;font-family: 'Roboto';"><span class="glf-button" data-glf-cuid="f562f605-7cf3-438b-ac2c-a3e4f242586b" data-glf-ruid="aabf9573-29e2-4ba8-9f31-12a08b2090ca" > Online Order</span></a>
            </div>
          </li>

          <!-- SLIDE  2-->
          <li data-transition="slotfade-horizontal" data-slotamount="1" data-masterspeed="500" data-title="Lamb Tikka Special">
            <!-- MAIN IMAGE -->
            <img src="/images/home/slider.jpg"  alt="slidebg1" data-lazyload="/images/home/slider.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYER NR. 2 -->
            <div class="tp-caption tp-resizeme sft" data-x="220" data-y="50" data-speed="1000" data-start="2400" data-endspeed="300" data-captionhidden="off" style="z-index: 7; max-width: auto; max-height: auto; font-family : 'Playball', sans-serif;color: #fff;font-size:91px; line-height:50px; text-align:center">
              <span class="slider-text-1" style="font-size: 33px;font-family: 'Merriweather', sans-serif;">welcome to</span><br>Thai Emperor!<br>
              <span class="slider-text-2" style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;  font-family: 'Roboto', sans-serif;text-transform: uppercase; font-size: 18px;letter-spacing: 4px; color: #fff;text-shadow:5px 5px 5px #000">best quality food</span><br>
              <a  target="_blank" href='https://www.thaiemperor.uk/order.aspx' class="slider-text-3 tr-slider-btn" style="z-index: 12; max-width: auto; max-height: auto; white-space: nowrap;font-size:22px;font-family: 'Roboto';"><span class="glf-button" data-glf-cuid="f562f605-7cf3-438b-ac2c-a3e4f242586b" data-glf-ruid="aabf9573-29e2-4ba8-9f31-12a08b2090ca" > Online Order</span></a>
            </div>
          </li>

          <!-- SLIDE 3 -->
          <li data-transition="slotfade-horizontal" data-slotamount="1" data-masterspeed="500" data-title="Chef's finishing touch">
            <!-- MAIN IMAGE -->
            <img src="/images/home/slider2.jpg"  alt="slidebg1" data-lazyload="/images/home/slider2.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYER NR. 2 -->
            <div class="tp-caption tp-resizeme sft" data-x="220" data-y="50" data-speed="1000" data-start="2400" data-endspeed="300" data-captionhidden="off" style="z-index: 7; max-width: auto; max-height: auto; font-family : 'Playball', sans-serif;color: #fff;font-size:91px; line-height:50px; text-align:center">
              <span class="slider-text-1" style="font-size: 33px;font-family: 'Merriweather', sans-serif;">Memorable</span><br>
                  Experience<br>
                  <span class="slider-text-2" style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;  font-family: 'Roboto', sans-serif;text-transform: uppercase; font-size: 18px;letter-spacing: 4px; color: #fff;text-shadow:5px 5px 5px #000">With fantastic service and great food</span><br>
                  <a target="_blank" href='https://www.thaiemperor.uk/order.aspx'  class="slider-text-3 tr-slider-btn" style="z-index: 12; max-width: auto; max-height: auto; white-space: nowrap;font-size:22px;font-family: 'Roboto';"><span class="glf-button" data-glf-cuid="f562f605-7cf3-438b-ac2c-a3e4f242586b" data-glf-ruid="aabf9573-29e2-4ba8-9f31-12a08b2090ca" > Online Order</span></a>
            </div>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-4">
        <div id="about-us" class="welcome-note text-center">
          ...
          <p class="note">An authentic and equally contemporary restaurant not only serving Thai food but a Thai culture rich in hospitality and warmth! A hidden gem of Swanley and surrounding areas, joy and pride of the locals! Very reasonably priced, excellent wine selection and award winning duo-managers always ensure that you are not just a customer but a royal guest in the house.
...
<style type="text/css">
  ...
  .ItemCat a{color: #f00;font-size: 18px; font-weight: bold;}
  .ItemSubCat a{color: #d00;font-size: 16px; font-weight: bold;padding-left: 15px}
  .gallery-items{overflow-x: auto}
</style>
    ...
    <div class="container"> 
      <div class="row"> 
        <div class="col-xs-12"> 
          ...
          <p class="slogan">All our food are made freshly to be healthy.<br><br>
            <a style="border:1px solid; padding:10px;color:#f00;" target="_blank" href="/uploads/Thai-Food-Menu.pdf">Download Food Menu</a></p>
        </div>
      </div>
        ...
        <div class="col-md-3 col-sm-3 sidebar-menu">
          <div class="gallery-trigger">
            <ul id="_filter">
             ...
             <li><a name="<?php echo e('cat'.$cat->id); ?>" onclick="showCat(this)"><?php echo e($cat->cat_name); ?></a>
      ...
      <div class="gallery-items">
       ...
       <div class="ItemCat" id="<?php echo e('cat'.$cat->id); ?>">
        <?php if($cat->image): ?>
        <img class="img-responsive" src="<?php echo e($cat->image); ?>">
        <?php else: ?>
      ...
      <div class="col-xs-12 col-sm-6">
        <div class="booking-back">
          <div class="booking-form">
            <h1>book a table</h1>
            <p class="slogan">best of dining experience<br><span style="font-size:18px">*Please check our business hours before making a reservation.</span></p>
            <?php echo Form::open(['route' => 'reservation.store', 'method' => 'POST', 'files' => true, 'name' => 'bookingForm', 'id' => 'booking_form', 'style' => 'display:none']); ?>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                  <input id="email-reservation" class="form-control" type="email" name="email" placeholder="e-mail" required>
                </div>
                <div class="col-xs-12 col-sm-6">
                ...
                <div class="col-xs-12 col-sm-12">
                  <textarea class="form-control" rows="3" name="details" placeholder="message &amp; special request" required></textarea>
                </div>
    ...
    <div class="col-sm-12 col-xs-12">
      <div id="reservation-slider" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
          ...
          <li data-target="#reservation-slider" data-slide-to="<?php echo e($r); ?>" class="<?php echo e($r == 0? 'active':''); ?>"></li>
          <?php $r++; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ol>
...
<!--====| Contact Us Start |====-->
  ...
  <style type="text/css">.gmap img{width:100%;}</style>
  <div class="gmap">
  ...
  <div class="book-now-wrapper">
    ...
    <div class="book-now "> 
      <div class="book-form">
        ...
        <?php echo Form::open(['route' => 'reservation.store', 'method' => 'POST', 'files' => true, 'name' => 'sidebarForm', 'id' => 'sidebar_form']); ?>
          ...
          <div class="col-xs-12 col-sm-12">
            <input id="datepicker-sidebar" class="form-control" type="text" name="time"  placeholder="Time: 00:00 AM/PM" required>
          </div>
          <div class="col-xs-12 col-sm-12">
